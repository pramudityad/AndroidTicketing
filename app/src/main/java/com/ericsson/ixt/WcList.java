...
public class WcList extends AppCompatActivity  implements NavigationView.OnNavigationItemSelectedListener {

    private ListView lvWcInbox;
    private CustomAdapter adapter;
    private List<ticketin> mWcInboxList;
    ...
    //JSON Array
    private JSONArray resultWcInbox;

    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.app_bar_wcanvas);
        ...
        lvWcInbox = (ListView)findViewById(R.id.lvworkingcanvas);

        mWcInboxList = new ArrayList<>();

        StringRequest stringRequest = new StringRequest(Request.Method.POST,"https://android.eid-tools.com/ixt_20_UAT/inticket_ongoing_wc.php",
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            resultWcInbox = j.getJSONArray(Utils.JSON_ARRAY);

                            //Calling method getStudents to get the students from the JSON Array
                            getWcInboxBody(resultWcInbox);
        ...
        btswapproject.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                startActivity(new Intent(WcList.this, ProjectSelector.class));
            }
        });


        lvWcInbox.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                String ticketid = mWcInboxList.get(position).getTicketid();
                String requestor = mWcInboxList.get(position).getRequestor();
                String siteid = mWcInboxList.get(position).getSiteid();
                String sitename = mWcInboxList.get(position).getSitename();
                String submittime = mWcInboxList.get(position).getSubmittime();
                String evactivity = mWcInboxList.get(position).getActivity();
                String mid = mWcInboxList.get(position).getMid();

                //Toast.makeText(Inbox.this, ticketid, Toast.LENGTH_LONG).show();


                Intent intent = new Intent(WcList.this, WcRplist.class);
                ...
                WcList.this.startActivity(intent);
   ...
   // private void addlistviewinbox() {
    ...
    private void getWcInboxBody(JSONArray j){
        //Traversing through all the items in the json array
        /*
        mWcInboxList.add(new ticketin("1111","1111","1111","1111","1111","1111","1111"));
        mWcInboxList.add(new ticketin("1111","1111","1111","1111","1111","1111","1111"));
        mWcInboxList.add(new ticketin("1111","1111","1111","1111","1111","1111","1111"));
        mWcInboxList.add(new ticketin("1111","1111","1111","1111","1111","1111","1111"));
        mWcInboxList.add(new ticketin("1111","1111","1111","1111","1111","1111","1111"));
...
*/
        for(int i=0;i<j.length();i++){
            try {
                ...
                mWcInboxList.add(new ticketin(ticketid,requestor,siteid,sitename,submittime,evactivity,mid));
       ...
       // spsiteid.setAdapter(new ArrayAdapter<String>(NewTicket.this, android.R.layout.simple_spinner_dropdown_item, ARsiteid));
        //Init adapter
        adapter = new CustomAdapter(getApplicationContext(), mWcInboxList);
        lvWcInbox.setAdapter(adapter);
    }
                                ...
                                try {
                                    ...
                                    if(!message.isEmpty()&&!updvers.isEmpty()){
                                        if(!updvers.equalsIgnoreCase(versionCode)){
                                            ...
                                            AlertDialog.Builder ab = new AlertDialog.Builder(WcList.this);
                                            ...
                                            ab.setNegativeButton("no", new DialogInterface.OnClickListener() {
                                                ...
                                                public void onClick(DialogInterface dialog, int which) {
                                                    dialog.dismiss();
                                                    ActivityCompat.finishAffinity(WcList.this);
                                                    WcList.this.finish();
                                                }
                                            });
    ...
    public void onBackPressed() {
        ...
        if (drawer.isDrawerOpen(GravityCompat.START)) {
            ...
            Intent setIntent = new Intent(WcList.this,MainActivity.class);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_dashboard) {
            ...
            userSession.setLoggedin(true);
            startActivity(new Intent(WcList.this, NewTicket.class));
            finish();
        } else if (id == R.id.nav_drop_in) {
            userSession.setLoggedin(true);
            startActivity(new Intent(WcList.this, Inbox.class));
            finish();
        } else if (id == R.id.nav_ongoing) {
            userSession.setLoggedin(true);
            startActivity(new Intent(WcList.this, SentTicket.class));
            finish();
        } else if (id == R.id.nav_closed) {
            userSession.setLoggedin(true);
            startActivity(new Intent(WcList.this, History.class));
            finish();
        } else if (id == R.id.nav_about) {
            userSession.setLoggedin(true);
            startActivity(new Intent(WcList.this, About.class));
            finish();
            ...
            ab.setPositiveButton("yes", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    ...
                    startActivity(new Intent(WcList.this, Login.class));
                    ActivityCompat.finishAffinity(WcList.this);
                    WcList.this.finish();
                    finish();
                }
